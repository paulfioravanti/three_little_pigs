...
module ThreeLittlePigs
  module Chapters
    class Chapter15WolfAttacksStickHouseTest < Minitest::Test
      attr_reader :story, :wolf, :first_pig, :second_pig, :third_pig

      def setup
        suppress_output do
          @story = Story.until_chapter(Chapter15WolfAttacksStickHouse)
          @first_pig = story.first_pig
          @second_pig = story.second_pig
          @third_pig = story.third_pig
          Chapter15WolfAttacksStickHouse.tell(story)
        end
      end
