...
module ThreeLittlePigs
  module Chapters
    class Chapter05FirstPigReceivesStrawTest < Minitest::Test
      attr_reader :story, :straw_man, :first_pig

      def setup
        suppress_output do
          @story = Story.until_chapter(Chapter05FirstPigReceivesStraw)
          Chapter05FirstPigReceivesStraw.tell(story)
        end
