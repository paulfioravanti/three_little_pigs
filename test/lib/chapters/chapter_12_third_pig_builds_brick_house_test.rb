...
module ThreeLittlePigs
  module Chapters
    class Chapter12ThirdPigBuildsBrickHouseTest < Minitest::Test
      attr_reader :story, :third_pig

      def setup
        suppress_output do
          @story = Story.until_chapter(Chapter12ThirdPigBuildsBrickHouse)
          Chapter12ThirdPigBuildsBrickHouse.tell(story)
        end
