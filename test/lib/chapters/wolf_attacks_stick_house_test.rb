  ...
  module Chapters
    class WolfAttacksStickHouseTest < Minitest::Test
      ...
      def test_the_little_pigs_ran_to_their_brothers_house_of_bricks
        assert_includes(third_pig.house.occupants, first_pig)
        assert_includes(third_pig.house.occupants, second_pig)
        assert_includes(third_pig.house.occupants, third_pig)
      end
    end
  end
end
