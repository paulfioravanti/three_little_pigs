...
module ThreeLittlePigs
  module Chapters
    class Chapter16WolfAttacksBrickHouseTest < Minitest::Test
      ...
      def setup
        suppress_output do
          @story = Story.until_chapter(Chapter16WolfAttacksBrickHouse)
          @wolf = story.wolf
          ...
          wolf.stub(:huff, huff_mock) do
            wolf.stub(:puff, puff_mock) do
              Chapter16WolfAttacksBrickHouse.tell(story)
            end
          end
        end
      end
