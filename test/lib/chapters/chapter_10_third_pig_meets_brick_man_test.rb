...
module ThreeLittlePigs
  module Chapters
    class Chapter10ThirdPigMeetsBrickManTest < Minitest::Test
      attr_reader :story, :brick_man

      def setup
        suppress_output do
          @story = Story.until_chapter(Chapter10ThirdPigMeetsBrickMan)
          Chapter10ThirdPigMeetsBrickMan.tell(story)
        end
