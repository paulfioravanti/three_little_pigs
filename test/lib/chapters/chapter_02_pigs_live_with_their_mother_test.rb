...
module ThreeLittlePigs
  module Chapters
    class Chapter02PigsLiveWithTheirMotherTest < Minitest::Test
      attr_reader :story, :mother_pig, :first_pig, :second_pig, :third_pig

      def setup
        suppress_output do
          @story = Story.until_chapter(Chapter02PigsLiveWithTheirMother)
          Chapter02PigsLiveWithTheirMother.tell(story)
        end
